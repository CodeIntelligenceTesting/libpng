# CITest.cmake
# Utility functions for testing libci
...
# ci_add_test(NAME <test> COMMAND <command> [OPTIONS <options>...] [FILES <files>...])
function(ci_add_test)
  set(options)
  set(oneValueArgs NAME COMMAND)
  set(multiValueArgs OPTIONS FILES)
  cmake_parse_arguments(_PAT "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
  if(NOT _PAT_NAME)
    message(FATAL_ERROR "ci_add_test: Missing NAME argument")
  endif()
  if(NOT _PAT_COMMAND)
    message(FATAL_ERROR "ci_add_test: Missing COMMAND argument")
  endif()
