Scripts and makefiles for libci
--------------------------------

    cilibconf.h.prebuilt  =>  Configuration settings
    ...
    makefile.linux    =>  Linux/ELF makefile
                          (gcc, creates shared libci16.so.16.1.6.*)
    makefile.mips     =>  MIPS makefile
    makefile.msys     =>  MSYS (MinGW) makefile
    makefile.netbsd   =>  NetBSD/cc makefile, makes shared libci.so
...
------------------------
    ...
    libci-config-body.in  =>  used by several makefiles to create libci-config
    libci-config-head.in  =>  used by several makefiles to create libci-config
    libci.pc.in      =>  Used by several makefiles to create libci.pc
    macro.lst         =>  Used by GNU Autotools
    ciwin.rc         =>  Used by the visualc71 project
    ciwin.def        =>  Used by makefile.os2
    ciwin.dfn        =>  Used to maintain ciwin.def
    SCOPTIONS.ppc     =>  Used with smakefile.ppc

    checksym.awk      =>  Used for maintaining cilibconf.h
    dfn.awk           =>  Used for maintaining cilibconf.h
    options.awk       =>  Used for maintaining cilibconf.h
    cilibconf.dfa    =>  Used for maintaining cilibconf.h
    cilibconf.mak    =>  Used for maintaining cilibconf.h
